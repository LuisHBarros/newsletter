...
public class Payment {
    ...
    public BillingSubscription getSubscription() {
        return subscription;
    }

    public void setSubscription(BillingSubscription subscription) {
    ...
    public void setProviderPaymentRef(String providerPaymentRef) {
